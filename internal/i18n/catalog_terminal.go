...
func init() {
	en := map[string]string{
		...
		"terminal.back": "  0  Back    q  Cancel", "terminal.exit": "  0  Exit    q  Quit", "terminal.choice": "Choose an action", "terminal.invalid": "Enter 1–%d, 0 to go back, or q to cancel.", "terminal.yes_no": "(yes/no)", "terminal.secret_long": "Input exceeds 4096 bytes.",
	}
	fa := map[string]string{
		...
		"terminal.back": "  0  بازگشت    q  لغو", "terminal.exit": "  0  خروج    q  خروج", "terminal.choice": "عملیات را انتخاب کنید", "terminal.invalid": "عدد 1 تا %d، برای بازگشت 0 یا برای لغو q را وارد کنید.", "terminal.yes_no": "(yes/no)", "terminal.secret_long": "ورودی بیشتر از 4096 بایت است.",
	}
	for k, v := range en {
		catalogs[En][k] = v
	}
