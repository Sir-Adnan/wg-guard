...
complete. **Phase 9 — Operational observability** is active at milestone 9.3.
...
| 9 — Operational observability | active; milestone 9.3 | Useful live metrics/logs with bounded cost and retention |
