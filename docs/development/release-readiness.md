...
complete. **Phase 9 — Operational observability** is active at milestone 9.2.
...
| 9 — Operational observability | active; milestone 9.2 | Useful live metrics/logs with bounded cost and retention |
