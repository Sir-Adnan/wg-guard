...
complete. **Phase 9 — Operational observability** is active at milestone 9.1.
...
| 9 — Operational observability | active; milestone 9.1 | Useful live metrics/logs with bounded cost and retention |
