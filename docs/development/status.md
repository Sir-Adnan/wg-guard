...
## Phase 9 — Operational observability (active, milestone 9.4)
...
shared snapshots. No Phase 9 behavior is yet claimed as real-VPS verified.
...
| 9 — Operational observability | active; milestone 9.4 | Live node/AWG metrics, dashboard telemetry, CLI logs, redaction, seven-day bounded retention |
